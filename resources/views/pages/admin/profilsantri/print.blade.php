    ...
    <main>
       <div class="">
        <div class="d-flex justify-content-between">
            ...
            <h4><span style="margin-right: 40px" class="d-flex text-center">nomor pendaftaran: <br>{{ "SB-".str_pad($siswa->id ,3,0,STR_PAD_LEFT)}}</span></h4>
        </div>
            ...
            <div class="" style="font-size: 22px">
                <div class="my-3 text-white">
                   @if (  $siswa->Instansi == "MAN" )
                       <span style="border-radius: 200px;background-color:rgba(0, 255, 0, 0.544);padding:10px 20px">Madrasah Aliyah</span>
                   @elseif(  $siswa->Instansi == "SMK")
                   <span style="border-radius: 200px;background-color:rgba(0, 30, 255, 0.631);padding:10px 20px">Sekolah Menengah Kejuruan </span>
                       @else
                       <span style="border-radius: 200px;background-color:rgb(255, 166, 0);padding:10px 20px">Madrasah Tsanawiyah</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="row text-center">
                                <div class="col ">
                                    <img style="margin-left: 130px" src="{{ asset($siswa->PasFoto) }}" height="130px" width="96px" alt="">
                                    <br>
                                   <span style="margin-left: 130px"> {{ ($siswa->JKelamin=="L"?"Laki-laki":"Perempuan") }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    type="checkbox" @if($siswa->status == "yatim")
                                        checked
                                        @elseif($siswa->status == "yatim-piatu")
                                        checked
                                    @endif name="" id=""><label class="mx-2" for="" >Yatim</label>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col" >
                            <div class="row">
                                <div class="col">
                                    ...
                                    @if($siswa->status == "piatu" )
                                        checked
                                        @elseif($siswa->status == "yatim-piatu")
                                        checked
                                    @endif
                                     name="" id=""><label class="mx-2" for="">Yatim</label>
