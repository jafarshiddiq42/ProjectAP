    ...
    <main>
        ...
        <div class="container-fluid px-4">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col"><select name="" class="form-control" id="table-filter">
                            ...
                            @forelse ($users as $user)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="/admin/batalkonfirmasiformulir" name="batalkonfirm"
                                            id="batalkonfirm{{ $user->siswas->id }}" method="post">
                                            @csrf
                                            <input type="text" name="idsiswa" class="d-none"
                                                value="{{ $user->siswas->id }}" id="">
                                        </form>
                                        <a href=""
                                            onclick="event.preventDefault();$('#batalkonfirm{{ $user->siswas->id }}').submit()"
                                            class="btn btn-datatable px-4  btn-icon btn-danger" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Batalkan Konfirmasi Data"><i
                                                class="fa-solid fa-eject"></i></a>
                                        <a href="/admin/santri/profil/{{ $user->id }}"
                                            class="btn btn-datatable px-4  btn-icon btn-primary" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Lihat Profil"><i class="fa-solid fa-eye"></i></a>
                                        <a href="/admin/santri/print/{{ $user->siswas->id }}" target="_blank"
                                            class="btn btn-datatable px-4  btn-icon btn-warning" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Print Formulir"><i
