                    ...
                    <div class="card mb-4 mb-xl-0">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="overflow-hidden">
                                <img class="img-account-profile rounded mb-2" src="{{ asset($user->siswas->PasFoto) }}"
                                    alt="" />
                            </div>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->buktipembayaran) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->buktipembayaran) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->ktp_ayah) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->ktp_ayah) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->ktp_ibu) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->ktp_ibu) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->surat_aktif) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->surat_aktif) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->NPSN) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->NPSN) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{  asset($user->dftrulangs->fc_kk) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->fc_kk) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-4 mb-4">
                            <!-- Billing card 1-->
                            <a href="{{ asset($user->dftrulangs->fc_akta) }}" target="_blank">
                                <div class="lift card bg-light">
                                    <div class="overflow-hidden" style="">
                                        <img class="card-img-top" src="{{ asset($user->dftrulangs->fc_akta) }}"
                                            alt="...">
                                    </div>
                                    <div class="card-body">
